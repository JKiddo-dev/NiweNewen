...
const Schedule = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsMobile(window.innerWidth < 768); // Puedes ajustar el valor de 768px según tus necesidades
    };
  ...
  return (
    <section id="schedule" className={`relative flex flex-col justify-center items-center min-w-screen ${isMobile ? 'min-h-[50vh]' : 'min-h-screen'} bg-[#F3EDDD]`}>
      <div className="container mx-auto px-4 lg:px-20">
        ...
        <p className="mb-4 text-center text-[#002315]">
        ...
        {isMobile ? (
          ...
          <div className="flex justify-center bg-white p-6 rounded-lg shadow-lg w-full h-[80vh] max-h-[850px] md:h-[70vh]">
            <iframe 
